...
const skills = [
  {
    ...
    description:
      "Designing responsive, accessible interfaces with a focus on usability and modern component libraries.",
    color: "text-blue-500",
  },
  {
    icon: Server,
  ...
  },
  {
    ...
    tech: "MySQL (plus MongoDB basics)",
    description: "Modeling relational schemas, writing efficient queries, and ensuring data integrity and performance.",
    color: "text-purple-500",
  },
  {
    icon: Layout,
    name: "UX Design",
    tech: "Prototyping, Wireframing, User research",
    description: "From idea to interface: prototyping and validating flows before implementation.",
    color: "text-pink-500",
  },
  {
    icon: GitBranch,
